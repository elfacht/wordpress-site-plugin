...
function foundation_top_bar_l() {
    wp_nav_menu(array(
        ...
        'menu' => '',                      	        // menu name
        'menu_class' => 'menu left',         	// adding custom nav class
...
class top_bar_walker extends Walker_Nav_Menu {
    ...
    /**
     * Output for CSS-only off-canvas menu
     *
     * Source: http://codepen.io/elfacht/pen/bNEdzp
     */
    function start_lvl(&$output, $depth = 0, $args = array()) {
        $hash = md5(mt_rand());
        $output .= "\n<input type=\"checkbox\" id=\"submenu_".$hash."\" class=\"nav__submenu-checkbox\"><label for=\"submenu_".$hash."\" class=\"nav__submenu-label\"></label> \n<ul class=\"nav__submenu dropdown\">\n";
    }
